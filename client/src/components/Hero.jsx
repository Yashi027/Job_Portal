  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white text-center py-16 mx-2 rounded-xl'>
        ...
        <p className='mb-8 font-light max-w-xl mx-auto text-sm px-5'>Your Next Big Career Move Starts Right Here - Explore the Best Job Opportunities and Take the First Step towards Your Future</p>
        <div className='flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
            ...
            <button onClick={onSearch} className='px-1.5 py-1.5 bg-blue-600 rounded text-white m-1'>Search</button>
        </div>
      </div>
